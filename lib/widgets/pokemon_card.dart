        ...
        children: <Widget>[
          Container(
            ...
            child: Stack(
              ...
              children: this.pokemonImageView(),
            ),
          ),
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(children: typeList()),
                SizedBox(height: 10),
                Row(
                  children: <Widget>[
                    Expanded(child: Text("Weight", style: title), flex: 1),
                    Text(pokemon.weight.toString()),
                  ],
                ),
                Row(
                  children: <Widget>[
                    Expanded(child: Text("Height", style: title), flex: 1),
                    Text(pokemon.height.toString()),
                  ],
                ),
                SizedBox(height: 10),
                Text("Weakness types", style: title),
                Container(
                  child: Wrap(
  ...
  List<Widget> pokemonImageView() {
    ...
    list.add(
      Positioned(
        top: offset,
        left: offset,
        child: Image.asset("assets/badges/${this.pokemon.type[0]}.png"),
      ),
    );
    ...
    if (this.pokemon.type.length > 1) {
      list.add(
        Positioned(
          bottom: offset,
          right: offset,
          child: Image.asset("assets/badges/${this.pokemon.type[1]}.png"),
        ),
      );
    }
...
class PokemonImagenTapView extends StatefulWidget {
  ...
  PokemonImagenTapView({required this.numberPokemon, super.key});
